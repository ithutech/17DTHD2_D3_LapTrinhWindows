...
namespace DemoLabWindowsForm.Utils
{
    /// <summary>
    /// Su kien kich hoat cac chuc nang cua chuong trinh
    /// </summary>
    public class EventSetControlEnable : EventArgs
    {
        public bool isUse { get; set; }
    }
    /// <summary>
    /// Uy quyen khi nguoi dung dang nhap vao he thong
    /// </summary>
    /// <param name="sender"></param>
    /// <param name="e"></param>
    public delegate void LoginSystemClick(object sender, EventSetControlEnable e);

    public static class MD5Demo
    {
        /// <summary>
